...
# )
#
macro(AutoBuild_use_package_MinVR YOUR_TARGET INTERFACE_PUBLIC_OR_PRIVATE)
    set(PACKAGE_NAME "MinVR")
        ...
        if ("${AUTOBUILD_EXECUTE_NOW}")
			...
			if (EXISTS "${AUTOBUILD_DOWNLOAD_DIR}/${PACKAGE_NAME}/CmakeLists.txt")
              ...
              AutoBuild_download_project( 
                  ${PACKAGE_NAME}
                 GIT_REPOSITORY https://github.com/kmilo9999/MinVR.git
				 GIT_TAG G3D_PLUGIN
              )
            endif()
			
			set(MinVRG3D_CONFIG_OPTIONS
                -DWITH_PLUGIN_G3D=ON
